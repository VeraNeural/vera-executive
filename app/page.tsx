      ...
      {mounted ? (
        <>
          <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 text-white relative overflow-hidden">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-300">Executive Intelligence</p>
                </div>
              </div>
              ...
              <div className="flex gap-2 mb-6">
                {(['executive', 'creative', 'personal', 'crisis'] as const).map((mode) => (
                  <button
                    ...
                    className={`relative z-10 cursor-pointer px-6 py-3 rounded-xl text-sm font-medium transition-all backdrop-blur-sm ${
                      executiveMode === mode
                ...
                >
                  {conversation.length === 0 ? (
                    <div className="text-center text-gray-200 mt-20">
                      ...
                      <p className="text-purple-200">Ready to assist with executive decisions, creative projects, and strategic planning.</p>
                    </div>
                  ) : (
                    <>
                ...
                >
                  <div className="flex gap-3">
                    <input
                      ...
                      className="flex-1 bg-white/10 backdrop-blur-sm text-white px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-400 border border-white/20 placeholder-gray-300"
                      disabled={isProcessing}
                    />
                    
                    <motion.button
                      onClick={() => isListening ? stopListening() : startListening()}
                      className={`relative z-10 cursor-pointer p-3 rounded-xl transition-all backdrop-blur-sm ${
                        isListening 
                    ...
                    <motion.button
                      ...
                      className="relative z-10 cursor-pointer px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl font-medium transition-all shadow-lg shadow-purple-500/30"
                      whileHover={{ scale: 1.05, boxShadow: '0 0 30px rgba(168, 85, 247, 0.6)' }}
                      whileTap={{ scale: 0.95 }}
                  ...
                  <div className="flex gap-2 mt-4">
                    <button
                      ...
                      className="relative z-10 cursor-pointer px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-sm transition-all border border-white/20 backdrop-blur-sm"
                    >
                      📧 Email
                    </button>
                    <button
                ...
                >
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-xl font-bold">Email Composer</h3>
                      <button
                        onClick={() => setShowEmailComposer(false)}
                    ...
                    <div className="space-y-4">
                      ...
                      <input
                        type="text"
                        placeholder="Subject: Meeting Follow-up"
                        className="w-full bg-gray-700 text-white px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                      />
                      <textarea
                        rows={8}
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            ...
                            className={`w-12 h-6 rounded-full transition-colors ${
                              isVoiceEnabled ? 'bg-purple-600' : 'bg-gray-600'
                            }`}
                          >
                      ...
                      <div>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            ...
                            className={`w-12 h-6 rounded-full transition-colors ${
                              shortcutsEnabled ? 'bg-purple-600' : 'bg-gray-600'
                            }`}
                          >
                            <div className={`w-5 h-5 bg-white rounded-full transition-transform ${
              ...
              {showCalendarPanel && (
                ...
                >
                  <motion.div
                    ...
                    animate={{ scale: 1, opacity: 1 }}
                    exit={{ scale: 0.9, opacity: 0 }}
                    className="bg-gray-800 rounded-xl p-6 w-full max-w-4xl mx-4 max-h-[80vh] overflow-y-auto"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="space-y-4">
                      {calendarEvents.length > 0 ? (
                          ...
                          <div key={event.id} className="bg-gray-700 rounded-lg p-4">
                            <div className="flex items-center justify-between">
                              ...
                              <span className={`px-2 py-1 rounded text-xs ${
                                event.energyRequired === 'high' ? 'bg-red-600' :
                                event.energyRequired === 'medium' ? 'bg-yellow-600' : 'bg-green-600'
                              }`}>
                                {event.energyRequired} energy
                              </span>
                            </div>
                        ...
                        <div className="text-center text-gray-400 py-8">
                          <p>No calendar events. Import your calendar to get started.</p>
                        </div>
                      )}
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="mb-6">
                      <button
                        ...
                        className="w-full px-4 py-3 border-2 border-dashed border-gray-600 rounded-lg hover:border-purple-500 transition-colors text-center"
                      >
                        Click to upload image for color extraction
                      </button>
                    </div>
                    ...
                    {colorPalette.length > 0 && (
                      <div className="space-y-6">
                        <div>
                          <h4 className="text-lg font-medium mb-3">Color Palette</h4>
                        ...
                        {designSystem && (
                          <>
                            <div>
                              <h4 className="text-lg font-medium mb-3">Typography</h4>
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {designSystem.fonts.map((fontPair, index) => (
                                  <div key={index} className="bg-gray-700 rounded-lg p-4">
                                    <p className="font-bold" style={{ fontFamily: fontPair.primary }}>
                                      {fontPair.primary}
                                    </p>
                                    <p className="text-sm" style={{ fontFamily: fontPair.secondary }}>
                                      {fontPair.secondary}
                                    </p>
                                  </div>
                                ))}
                            ...
                            <div>
                              <h4 className="text-lg font-medium mb-3">Materials</h4>
                              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                                {designSystem.materials.map((material, index) => (
                    ...
                    {colorPalette.length === 0 && (
                      <div className="text-center text-gray-400 py-8">
                        <p>Upload an image to extract colors and generate a design system.</p>
                      </div>
                    )}
                  </motion.div>
                </motion.div>
            ...
            <AnimatePresence>
              {showBiometricsPanel && (
                <motion.div
                  ...
                  exit={{ opacity: 0 }}
                  className="fixed inset-0 bg-black/50 flex items-center justify-center z-50"
                  onClick={() => setShowBiometricsPanel(false)}
                >
                  <motion.div
                    initial={{ scale: 0.9, opacity: 0 }}
                    animate={{ scale: 1, opacity: 1 }}
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-xl font-bold">Health & Biometrics</h3>
                      <button
                        onClick={() => setShowBiometricsPanel(false)}
                        className="text-gray-400 hover:text-white"
                      >
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-gray-700 rounded-lg p-4 text-center">
                          <div className="text-2xl font-bold text-red-400">{Math.round(biometricData.heartRate)}</div>
                          <div className="text-sm text-gray-400">Heart Rate (BPM)</div>
                        </div>
                        <div className="bg-gray-700 rounded-lg p-4 text-center">
                          <div className="text-2xl font-bold text-blue-400">{Math.round(biometricData.hrv)}</div>
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <div className="bg-gray-700 rounded-lg p-4 text-center">
                          <div className={`text-xl font-bold ${
                            biometricData.stress === 'low' ? 'text-green-400' :
                            biometricData.stress === 'medium' ? 'text-yellow-400' : 'text-red-400'
                          }`}>
                        ...
                        <div className="bg-gray-700 rounded-lg p-4 text-center">
                          <div className={`text-xl font-bold ${
                            biometricData.focus === 'high' ? 'text-green-400' :
                            biometricData.focus === 'medium' ? 'text-yellow-400' : 'text-red-400'
                          }`}>
                            {biometricData.focus}
                          </div>
                        ...
                        <div className="bg-gray-700 rounded-lg p-4 text-center">
                          <div className={`text-xl font-bold ${
                            biometricData.energy === 'optimal' ? 'text-green-400' :
                            biometricData.energy === 'moderate' ? 'text-yellow-400' : 'text-red-400'
                          }`}>
                            {biometricData.energy}
                          </div>
                      ...
                      <div className="bg-gray-700 rounded-lg p-4">
                        ...
                        <ul className="text-sm text-gray-300 space-y-1">
                          {biometricData.stress === 'high' && (
                            <li>• Take a 10-minute break - stress levels elevated</li>
                          )}
                          {biometricData.focus === 'low' && (
                            <li>• Consider a 5-minute walk to improve focus</li>
                          )}
                          {biometricData.energy === 'low' && (
                            <li>• Schedule lighter tasks - energy reserves low</li>
                          )}
                          {biometricData.stress === 'low' && biometricData.focus === 'high' && (
                            <li>• Optimal time for high-concentration tasks</li>
                          )}
                        </ul>
                      </div>
                      
                      <div className="text-xs text-gray-500 text-center">
                        Last updated: {biometricData.lastUpdated.toLocaleString()}
                      </div>
                    </div>
                  </motion.div>
                </motion.div>
            ...
            {/* Decision Panel */}
            <AnimatePresence>
              {showDecisionPanel && decisionAnalysis && (
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                ...
                >
                  <motion.div
                    ...
                    animate={{ scale: 1, opacity: 1 }}
                    exit={{ scale: 0.9, opacity: 0 }}
                    className="bg-gray-800 rounded-xl p-6 w-full max-w-3xl mx-4 max-h-[80vh] overflow-y-auto"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-xl font-bold">Decision Analysis</h3>
                      <button
                        onClick={() => setShowDecisionPanel(false)}
                        className="text-gray-400 hover:text-white"
                      >
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <ul className="space-y-2">
                            {decisionAnalysis.pros.map((pro, index) => (
                              <li key={index} className="text-sm bg-green-900/20 p-2 rounded">
                                • {pro}
                              </li>
                            ))}
                          </ul>
                        ...
                        <div>
                          ...
                          <ul className="space-y-2">
                            {decisionAnalysis.cons.map((con, index) => (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="bg-gray-700 rounded-lg p-4">
                          ...
                          <p className="text-sm text-gray-300">{decisionAnalysis.roi}</p>
                        </div>
                        <div className="bg-gray-700 rounded-lg p-4">
                          <h4 className="font-medium mb-2">Risk Level</h4>
                          <span className={`text-sm font-bold ${
                            decisionAnalysis.risk === 'low' ? 'text-green-400' :
                            decisionAnalysis.risk === 'medium' ? 'text-yellow-400' : 'text-red-400'
                          }`}>
                            {decisionAnalysis.risk.toUpperCase()}
                          </span>
                        </div>
                        <div className="bg-gray-700 rounded-lg p-4">
                          <h4 className="font-medium mb-2">Timeline</h4>
                          <p className="text-sm text-gray-300">{decisionAnalysis.timeline}</p>
                        </div>
                      </div>
                      
                      <div className="bg-purple-900/20 rounded-lg p-4">
                        <h4 className="font-medium text-purple-400 mb-2">Recommendation</h4>
                        <p className="text-sm">{decisionAnalysis.recommendation}</p>
                        <div className="mt-2">
                          <span className="text-xs text-gray-400">Confidence: </span>
                          <span className="text-sm font-bold">{decisionAnalysis.confidence}%</span>
                        </div>
                      </div>
                      
                      {decisionAnalysis.alternatives && decisionAnalysis.alternatives.length > 0 && (
                        <div>
                          <h4 className="font-medium mb-3">Alternative Options</h4>
                          <ul className="space-y-2">
                            {decisionAnalysis.alternatives.map((alt, index) => (
